...
Course | Project # 4 : Build a logistic regression model				

Your project will be assessed using the following standards:
					
- [ ] Standard 1 Write a high quality problem statement
- [ ] Standard 2 Perform exploratory analysis methods with visualization and statistical analysis
- [ ] Standard 3 Build a logistic regression model
...
|---|---|---|---|---|
| Specific Requirement #1 Outline  the project methods and models | | | | |
| Specific Requirement #2 Provide a description of the logistic regression model | | | | |
| Specific Requirement #3 The executive summary| | | | |
